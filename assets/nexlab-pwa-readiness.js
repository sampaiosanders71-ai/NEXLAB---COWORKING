(function(){
  'use strict';
  const BUILD_IDENTITY=window.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.11',release:'Beta',revision:'beta-0-26-11-device-homologation-server-evidence',assetRevision:'app-beta-0-26-11-device-homologation-server-evidence',cacheName:'nexlab-beta-0-26-11-device-homologation-server-evidence'});
  ...
  const EXPECTED_CORE=['index.html','offline.html','manifest.webmanifest','assets/nexlab-release-identity.js','assets/index-beta-0-26-11.js','assets/nexlab-vendor-beta-0-26-11.js','assets/nexlab-app-shared-beta-0-26-11.js','assets/nexlab-dialogs.js','assets/nexlab-push-navigation.js','assets/nexlab-device-homologation.js'];
  const EXPECTED_OPTIONAL=['assets/nexlab-feature-modules-beta-0-26-11.js','assets/nexlab-export-vendor-beta-0-26-11.js','assets/nexlab-pwa-readiness.js','pwa-check.html'];
  const OPTIONAL_WARM=['assets/nexlab-feature-modules-beta-0-26-11.js','assets/nexlab-export-vendor-beta-0-26-11.js'];
  const OFFLINE_PROBE=['index.html','offline.html','assets/nexlab-release-identity.js','assets/index-beta-0-26-11.js','assets/nexlab-push-navigation.js','assets/nexlab-device-homologation.js'];
  ...
  async function run(){
    ...
    const featureCached=cache.optional.every(item=>item.asset!=='assets/nexlab-feature-modules-beta-0-26-11.js'||!item.cached||item.integrity);
    const exportCached=cache.optional.every(item=>item.asset!=='assets/nexlab-export-vendor-beta-0-26-11.js'||!item.cached||item.integrity);
