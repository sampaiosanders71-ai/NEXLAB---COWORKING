(function(){
  'use strict';
  const BUILD_IDENTITY=window.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.21',release:'Beta',revision:'beta-0-26-21-feedback-external-evidence-upload-fix',assetRevision:'app-beta-0-26-21-feedback-external-evidence-upload-fix',cacheName:'nexlab-beta-0-26-21-feedback-external-evidence-upload-fix'});
  ...
  const HOMOLOGATION_REVISION=BUILD_IDENTITY.homologationRevision||'beta-0-26-21-feedback-external-evidence-upload-fix';
