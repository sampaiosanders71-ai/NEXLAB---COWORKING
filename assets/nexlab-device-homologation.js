(function(){
  'use strict';
  const BUILD=globalThis.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.11',revision:'beta-0-26-11-device-homologation-server-evidence'});
  ...
  const RPC='nexlab_record_device_homologation_v02611';
