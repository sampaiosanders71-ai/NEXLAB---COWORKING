/* NEXLAB Beta 0.26.17 — navegação Push com confirmação explícita, deduplicação e fallback seguro. */
(()=>{
  if(globalThis.__NEXLAB_PUSH_NAVIGATION__?.version==='0.26.17')return;
  ...
  const writeEvidence=(patch)=>{
    ...
    const next={...current,version:VERSION,revision:'beta-0-26-17-role-permission-downgrade-integrity',userAgent:navigator.userAgent,updatedAt:new Date().toISOString(),...patch};
