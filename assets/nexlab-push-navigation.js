/* NEXLAB Beta 0.26.18 — navegação Push com confirmação explícita, deduplicação e fallback seguro. */
(()=>{
  if(globalThis.__NEXLAB_PUSH_NAVIGATION__?.version==='0.26.18')return;
  ...
  const writeEvidence=(patch)=>{
    ...
    const next={...current,version:VERSION,revision:'beta-0-26-18-contextual-visibility-by-role',userAgent:navigator.userAgent,updatedAt:new Date().toISOString(),...patch};
