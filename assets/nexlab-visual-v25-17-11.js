(function(){
  if (window.__NEXLAB_V25_17_11_VISUAL__) return;
  window.__NEXLAB_V25_17_11_VISUAL__ = true;

  const VERSION = '25.17.11';
  const BRAND = 'brand-r24';
  const ONBOARDING_KEY = 'nexlab:onboarding:v1:done';
  const CHANGELOG_KEY = 'nexlab:changelog:25.17.11:seen';
  ...
  function warmOfflineCache(){
    ...
    const files = [
      ...
      './changelog.html',
      './publicacao.html',
      `./assets/nexlab-bootstrap-v25-17-11.js?v=${BRAND}`,
      `./assets/index-CKPsxFpP.js?v=${BRAND}`,
      `./assets/index-B1u8eynw.css?v=${BRAND}`,
      `./assets/nexlab-visual-v25-17-11.css?v=${BRAND}`,
      `./assets/nexlab-visual-v25-17-11.js?v=${BRAND}`,
    ...
    caches.open('nexlab-v25-17-11-runtime-r1')
  ...
  function publicationChecklistMarkup(){
    const items = [
      ['Versão e cache', 'Confirmar NEXLAB v' + VERSION + ', manifest, Service Worker, cache brand-r24 e botão “Atualizar app”.'],
  ...
  function copyPublicationChecklist(){
    const text = [
      ...
      '- Versão e cache: manifest, Service Worker, cache brand-r24 e botão Atualizar app.',
