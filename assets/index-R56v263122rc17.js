/* NEXLAB Beta 0.26.18 — entrada legada redirecionada para o bundle atual. */
const __nexlabCompatibilityDetail=Object.freeze({group:"legacy-26-31-22",sourceVersion:"26.31.22",targetVersion:"0.26.18",assetPath:"assets/index-R56v263122rc17.js",mode:'lightweight-bridge',usedAt:new Date().toISOString()});
...
import('./index-beta-0-26-12.js?v=app-beta-0-26-18-contextual-visibility-by-role').catch((error)=>{
