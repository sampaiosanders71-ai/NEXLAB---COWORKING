(function(){
  ...
  async function loadMatrix(force=false){
    ...
    }catch(error){console.error('Permissões R55.4:',error);toast(error.message||'Não foi possível carregar a matriz de permissões.','err');return null}
