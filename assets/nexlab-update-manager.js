(function(){
  'use strict';
  if (window.__NEXLAB_UPDATE_MANAGER__?.version === '26.30.36') return;

  const CURRENT_VERSION = '26.30.36';
  const CURRENT_REVISION = 'permission-confirmation-full-admin-r55624';
