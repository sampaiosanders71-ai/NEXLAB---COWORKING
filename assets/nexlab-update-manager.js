(function(){
  ...
  const BUILD_IDENTITY = window.__NEXLAB_BUILD_IDENTITY__ || Object.freeze({version:'0.26.11',release:'Beta',revision:'beta-0-26-11-device-homologation-server-evidence',generatedAt:'2026-07-19T19:39:27Z',cacheName:'nexlab-beta-0-26-11-device-homologation-server-evidence'});
