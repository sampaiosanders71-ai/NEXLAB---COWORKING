(function(){
  ...
  window.__NEXLAB_VAPID_ROTATION_BETA_0264__={version:'0.26.11',status:'idle'};
  ...
  function markerValue(subscription){return `0.26.11:${subscription?.endpoint||''}`}
  ...
  async function rotate(){
    ...
    window.dispatchEvent(new CustomEvent('nexlab:vapid-rotated',{detail:{status:state.status,version:'0.26.11'}}));
  }
