(function(){
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.31.4';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.31.4';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.31.4', JSON.stringify(performanceState));
    } catch {}
