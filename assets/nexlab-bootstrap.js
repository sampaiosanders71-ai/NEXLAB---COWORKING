(function(){
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.43';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.43';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.43', JSON.stringify(performanceState));
    } catch {}
