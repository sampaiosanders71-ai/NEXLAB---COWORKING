(function(){
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.28';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.28';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.28', JSON.stringify(performanceState));
    } catch {}
