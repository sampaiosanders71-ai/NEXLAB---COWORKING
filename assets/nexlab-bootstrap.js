(function(){
  ...
  const APP_VERSION = '26.30.12';
  const APP_RELEASE = 'R55.5.2';
  const APP_REVISION = 'pending-contract-dom-telemetry-r5552';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.12';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.12';
