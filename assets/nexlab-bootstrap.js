(function(){
  ...
  const APP_RELEASE = 'R55.6.6';
  const APP_REVISION = 'stability-core-r5566';
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.19';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.19';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.19', JSON.stringify(performanceState));
    } catch {}
