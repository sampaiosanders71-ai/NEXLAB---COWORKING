(function(){
  ...
  const OBSERVABILITY_QUEUE_KEY = 'nexlab:observability:queue:v26.30.36';
  const OBSERVABILITY_DEDUP_KEY = 'nexlab:observability:dedup:v26.30.36';
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.30.36', JSON.stringify(performanceState));
    } catch {}
