(function(){
  if (window.__NEXLAB_BOOTSTRAP_V26_3__) return;
  window.__NEXLAB_BOOTSTRAP_V26_3__ = true;
  ...
  function savePerformanceState(){
    ...
    try {
      sessionStorage.setItem('nexlab:performance:v26.3', JSON.stringify(performanceState));
    } catch {}
