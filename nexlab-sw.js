...
const BUILD_IDENTITY=self.__NEXLAB_BUILD_IDENTITY__||Object.freeze({version:'0.26.11',release:'Beta',revision:'beta-0-26-11-device-homologation-server-evidence',assetRevision:'app-beta-0-26-11-device-homologation-server-evidence',cacheName:'nexlab-beta-0-26-11-device-homologation-server-evidence',generatedAt:'2026-07-19T19:39:27Z'});
...
const MAIN_BUNDLE='index-beta-0-26-11.js';
const VENDOR_BUNDLE='nexlab-vendor-beta-0-26-11.js';
const SHARED_BUNDLE='nexlab-app-shared-beta-0-26-11.js';
const FEATURE_BUNDLE='nexlab-feature-modules-beta-0-26-11.js';
const EXPORT_BUNDLE='nexlab-export-vendor-beta-0-26-11.js';
...
const MANDATORY_SHELL=[
  ...
  `./assets/nexlab-realtime-core-beta-0-26-11.js?v=${ASSET_REVISION}`,
  `./assets/nexlab-update-manager.js?v=${ASSET_REVISION}`,
  `./assets/nexlab-realtime-hub-beta-0-26-11.js?v=${ASSET_REVISION}`,
