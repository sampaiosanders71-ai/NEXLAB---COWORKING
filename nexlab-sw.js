const APP_VERSION='26.30.19';
const APP_REVISION='publication-syntax-fix-r5566';
const CACHE_NAME='nexlab-v26-30-19-shell-r5566';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26319-publication-syntax-fix-r5566',
  './assets/index-R55v26319.js?v=app-r26319-publication-syntax-fix-r5566',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26319-publication-syntax-fix-r5566',
  './assets/nexlab-update-manager.js?v=app-r26319-publication-syntax-fix-r5566',
  './assets/nexlab-realtime-hub-r5566.js?v=app-r26319-publication-syntax-fix-r5566',
  './assets/nexlab-visual.css?v=app-r26319-publication-syntax-fix-r5566',
  './assets/nexlab-visual.js?v=app-r26319-publication-syntax-fix-r5566',
  './assets/nexlab-vapid-rotation.js?v=app-r26319-publication-syntax-fix-r5566',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26319.js?v=app-r26319-publication-syntax-fix-r5566',self.registration.scope).href,
