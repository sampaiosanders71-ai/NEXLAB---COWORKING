const APP_VERSION='26.30.27';
const APP_REVISION='mobile-search-swipe-r55614';
const CACHE_NAME='nexlab-v26-30-27-shell-r55614';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26327-mobile-search-swipe-r55614',
  './assets/index-R55v26327.js?v=app-r26327-mobile-search-swipe-r55614',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26327-mobile-search-swipe-r55614',
  './assets/nexlab-update-manager.js?v=app-r26327-mobile-search-swipe-r55614',
  './assets/nexlab-realtime-hub-r55614.js?v=app-r26327-mobile-search-swipe-r55614',
  './assets/nexlab-visual.css?v=app-r26327-mobile-search-swipe-r55614',
  './assets/nexlab-visual.js?v=app-r26327-mobile-search-swipe-r55614',
  './assets/nexlab-vapid-rotation.js?v=app-r26327-mobile-search-swipe-r55614',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26327.js?v=app-r26327-mobile-search-swipe-r55614',self.registration.scope).href,
