const APP_VERSION='26.30.30';
const APP_REVISION='mural-write-permissions-r55618';
const CACHE_NAME='nexlab-v26-30-30-shell-r55618';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26330-mural-write-permissions-r55618',
  './assets/index-R55v26330.js?v=app-r26330-mural-write-permissions-r55618',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26330-mural-write-permissions-r55618',
  './assets/nexlab-update-manager.js?v=app-r26330-mural-write-permissions-r55618',
  './assets/nexlab-realtime-hub-r55618.js?v=app-r26330-mural-write-permissions-r55618',
  './assets/nexlab-visual.css?v=app-r26330-mural-write-permissions-r55618',
  './assets/nexlab-visual.js?v=app-r26330-mural-write-permissions-r55618',
  './assets/nexlab-vapid-rotation.js?v=app-r26330-mural-write-permissions-r55618',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26330.js?v=app-r26330-mural-write-permissions-r55618',self.registration.scope).href,
