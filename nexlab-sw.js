const APP_VERSION='26.30.28';
const APP_REVISION='dashboard-switcher-mobile-r55615';
const CACHE_NAME='nexlab-v26-30-28-shell-r55615';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/index-R55v26328.js?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/nexlab-update-manager.js?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/nexlab-realtime-hub-r55615.js?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/nexlab-visual.css?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/nexlab-visual.js?v=app-r26328-dashboard-switcher-mobile-r55615',
  './assets/nexlab-vapid-rotation.js?v=app-r26328-dashboard-switcher-mobile-r55615',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26328.js?v=app-r26328-dashboard-switcher-mobile-r55615',self.registration.scope).href,
