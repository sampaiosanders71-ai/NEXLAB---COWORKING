const APP_VERSION='26.31.4';
const APP_REVISION='stable-cleanup-r5604';
const CACHE_NAME='nexlab-v26-31-4-stable-r5604';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26314-stable-cleanup-r5604',
  './assets/index-R56v26314stable.js?v=app-r26314-stable-cleanup-r5604',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26314-stable-cleanup-r5604',
  './assets/nexlab-runtime-stability-r5604stable.js?v=app-r26314-stable-cleanup-r5604',
  './assets/nexlab-update-manager.js?v=app-r26314-stable-cleanup-r5604',
  './assets/nexlab-realtime-hub-r5604stable.js?v=app-r26314-stable-cleanup-r5604',
  './assets/nexlab-visual.css?v=app-r26314-stable-cleanup-r5604',
  './assets/nexlab-visual.js?v=app-r26314-stable-cleanup-r5604',
  './assets/nexlab-vapid-rotation.js?v=app-r26314-stable-cleanup-r5604',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R56v26314stable.js?v=app-r26314-stable-cleanup-r5604',self.registration.scope).href,
