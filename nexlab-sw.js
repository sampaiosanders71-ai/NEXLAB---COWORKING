const CACHE_NAME = "nexlab-v26-7-5-2-shell-r1";
const RUNTIME_CACHE = "nexlab-v26-7-5-2-runtime-r1";
const IMAGE_CACHE = "nexlab-v26-7-5-2-images-r1";
...
const SHELL_FILES = [
  ...
  "./assets/index-CKPsxFpP.js?v=app-r2675-pass8",
  "./assets/index-B1u8eynw.css?v=brand-r38",
  "./assets/nexlab-bootstrap-v26-7.js?v=app-r2675-pass8",
  "./assets/nexlab-visual-v26-7.css?v=brand-r38",
  "./assets/nexlab-visual-v26-7.js?v=app-r2675-pass8",
