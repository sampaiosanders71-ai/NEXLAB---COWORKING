const APP_VERSION="26.30.4";
const APP_REVISION="integrated-homologation-r554";
const CACHE_NAME="nexlab-v26-30-4-shell-r554";
const RUNTIME_CACHE="nexlab-v26-30-4-runtime-r554";
const IMAGE_CACHE="nexlab-v26-30-4-images-r554";
const ASSET_VERSION="app-r26304-integrated-homologation-r554";
const SHELL_FILES=[
  "./","./index.html","./offline.html","./404.html","./homologacao.html",
  "./RELATORIO_NEXLAB_V26_30_4.html","./prontidao.html","./release.json",
  `./manifest.webmanifest?v=${ASSET_VERSION}`,
  `./assets/index-R55v26304.js?v=${ASSET_VERSION}`,
