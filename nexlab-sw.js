const APP_VERSION='26.30.45';
const APP_REVISION='meetings-list-stable-r55633';
const CACHE_NAME='nexlab-v26-30-45-shell-r55633';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26345-meetings-list-stable-r55633',
  './assets/index-R55v26345.js?v=app-r26345-meetings-list-stable-r55633',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26345-meetings-list-stable-r55633',
  './assets/nexlab-update-manager.js?v=app-r26345-meetings-list-stable-r55633',
  './assets/nexlab-realtime-hub-r55633.js?v=app-r26345-meetings-list-stable-r55633',
  './assets/nexlab-visual.css?v=app-r26345-meetings-list-stable-r55633',
  './assets/nexlab-visual.js?v=app-r26345-meetings-list-stable-r55633',
  './assets/nexlab-vapid-rotation.js?v=app-r26345-meetings-list-stable-r55633',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26345.js?v=app-r26345-meetings-list-stable-r55633',self.registration.scope).href,
