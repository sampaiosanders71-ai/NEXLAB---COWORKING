const APP_VERSION='26.30.44';
const APP_REVISION='meetings-module-open-recovery-r55632';
const CACHE_NAME='nexlab-v26-30-44-shell-r55632';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/index-R55v26344.js?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/nexlab-update-manager.js?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/nexlab-realtime-hub-r55632.js?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/nexlab-visual.css?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/nexlab-visual.js?v=app-r26344-meetings-module-open-recovery-r55632',
  './assets/nexlab-vapid-rotation.js?v=app-r26344-meetings-module-open-recovery-r55632',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26344.js?v=app-r26344-meetings-module-open-recovery-r55632',self.registration.scope).href,
