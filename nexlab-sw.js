const APP_VERSION='26.30.35';
const APP_REVISION='desktop-search-layout-r55623';
const CACHE_NAME='nexlab-v26-30-35-shell-r55623';
...
const APP_SHELL=[
  ...
  './index.html',
  './offline.html',
  './manifest.webmanifest?v=app-r26333-desktop-search-layout-r55623',
  './assets/index-R55v26335.js?v=app-r26333-desktop-search-layout-r55623',
  './assets/index-B1u8eynw.css?v=brand-r38',
  './assets/nexlab-bootstrap.js?v=app-r26333-desktop-search-layout-r55623',
  './assets/nexlab-update-manager.js?v=app-r26333-desktop-search-layout-r55623',
  './assets/nexlab-realtime-hub-r55623.js?v=app-r26333-desktop-search-layout-r55623',
  './assets/nexlab-visual.css?v=app-r26333-desktop-search-layout-r55623',
  './assets/nexlab-visual.js?v=app-r26333-desktop-search-layout-r55623',
  './assets/nexlab-vapid-rotation.js?v=app-r26333-desktop-search-layout-r55623',
...
const CORE_SHELL=new Set([
  ...
  new URL('./assets/index-R55v26335.js?v=app-r26333-desktop-search-layout-r55623',self.registration.scope).href,
